...
\title{Scouter9000: An Approach to Finding People in Crowds}
...
\begin{abstract}
This paper presents the application of low-powered bluetooth as an approach to sensor detection. Location people in crowds is one such application. Apple's Bluetooth low energy (BLE) protocol, iBeacon, was considered and experimented for this paper.
\end{abstract}
...
\section{Conclusions}
In conclusion, our approach was 

%ACKNOWLEDGMENTS are optional
\section{Acknowledgments}
We would like to thank Professor Ting Zhu of Binghamton University for his help in our bluetooth low energy approach. The paper he sent us allowed us to fully understand the low-powered bluetooth approach.
%
